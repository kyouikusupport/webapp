...
function togglePlayPause() {
    if (isPlaying) {
        ...
        document.getElementById("playPauseButton").textContent = "さいせい";
    } else {
        // 停止中なら再生を開始
        isPlaying = true;
        document.getElementById("playPauseButton").textContent = "ていし";
        playAnimation();
    }
}
